...
logo.Image = "http://www.roblox.com/asset/?id=94678517792779"
...
-- THÊM: đổi tên intro thành nyann os
msg.Text = "nyann os"
...
local Tabs = {
    Info = Window:MakeTab({ Title = "Thông tin và trạng thái", Icon = "Info" }),
    Main = Window:MakeTab({ Title = "Cày", Icon = "rbxassetid://7733960981" }),
    Settings = Window:MakeTab({ Title = "Cài đặt", Icon = "rbxassetid://7734053495" }),
    Fish = Window:MakeTab({ Title = "Câu cá", Icon = "rbxassetid://127664059821666" }),
    Quests = Window:MakeTab({ Title = "Nhiệm vụ và vật phẩm", Icon = "rbxassetid://13075622619" }),
    SeaEvent = Window:MakeTab({ Title = "Sự kiện biển", Icon = "waves" }),
    Race = Window:MakeTab({ Title = "Nâng cấp chủng tộc", Icon = "rbxassetid://11162889532" }),
    Prehistoric = Window:MakeTab({ Title = "Đảo núi lửa", Icon = "tent" }),
    Esp = Window:MakeTab({ Title = "Chỉ số/Hiển thị", Icon = "rbxassetid://7040410130" }),
    Raids = Window:MakeTab({ Title = "Trái/Đột kích", Icon = "rbxassetid://11155986081" }),
    Combat = Window:MakeTab({ Title = "Thuộc người chơi", Icon = "rbxassetid://13075651575" }),
    Travel = Window:MakeTab({ Title = "Dịch chuyển", Icon = "locate" }),
    Shop = Window:MakeTab({ Title = "Của hàng", Icon = "rbxassetid://6031265976" }),
    Misc = Window:MakeTab({ Title = "Linh tinh", Icon = "rbxassetid://10709783577" })
}
...
Tabs.Info:AddSection("Trạng thái")

local TimeZone = Tabs.Info:AddParagraph("Giờ", "")
...
local GameTime = Tabs.Info:AddParagraph("Thời gian chơi game", "")
...
local MirageCheck = Tabs.Info:AddParagraph("Đảo bí ẩn", "Trạng thái: ")
...
local KitsuneCheck = Tabs.Info:AddParagraph("Đảo cáo quỷ", "Trạng thái: ")
...
local PrehistoricCheck = Tabs.Info:AddParagraph("Đảo tiền sử", "Trạng thái: ")
...
local FrozenCheck = Tabs.Info:AddParagraph("Đảo levi", "Trạng thái: ")
...
local CakePrinceStatus = Tabs.Info:AddParagraph("Tư lệnh bột", "")
...
local RipIndraCheck = Tabs.Info:AddParagraph("Trùm đột kích", "Trạng thái: ")
...
local DoughKingCheck = Tabs.Info:AddParagraph("Bột đế vương", "Trạng thái: ")
...
local FullMoonCheck = Tabs.Info:AddParagraph("Trăng tròn", "")
...
local BoneCount = Tabs.Info:AddParagraph("Xương", "")
...
Tabs.Main:AddDropdown({
    Name = "Tỉ lệ giao diện",
    Options = {"Nhỏ", "Bình thường", "Lớn"},
    Default = "Bình thường",
    Callback = function(Value)
...
ChestBP = Tabs.Main:AddToggle({
    Name = "Tự động mở rương xuyên tường", 
    Description = "",
    Default = false,
    Callback = function(Value)
...
EliteH = Tabs.Main:AddToggle({
	Name = "Tự động farm Elite + đổi server",
	Description = "",
	Default = false,
	Callback = function(Value)
	_G.FarmEliteH = Value
...
CakeSM = Tabs.Main:AddToggle({
    Name = "Tự động triệu hồi Cake Prince",
    Description = "",
    Default = false,
    Callback = function(Value)
...
Tabs.Main:AddToggle({
    Name = "Tự động Dough King [Hoàn toàn]",
    Default = false,
    Callback = function(Value)
...
Tabs.Main:AddToggle({
    Name = "Tự động farm Dough King + đổi server",
    Default = false,
    Callback = function(Value)
...
Name = "Tự động nhặt xương ngẫu nhiên", 
Description = "", 
Default = false,
Callback = function(Value)
...
Name = "Tự động thử vận may tại bia mộ", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.TryLucky = Value
...
Name = "Tự động cầu nguyện tại bia mộ", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.Praying = Value
...
Tabs.Settings:AddToggle({
    Name = "Tự động đổi server theo thời gian",
    Default = false,
    Callback = function(Value)
...
Tabs.Settings:AddSlider({
    Name = "Thời gian chờ đổi server (phút)",
    Min = 5,
    Max = 120,
    Default = 30,
    Increment = 1,
...
Tabs.Settings:AddToggle({
    Name = "Tự động bật Haki Quan Sát",
    Default = false,
    Callback = function(Value)
...
Name = "Xóa hiệu ứng chết & hồi sinh", 
Description = "", 
Default = false,
Callback = function(Value)
  RDeath = Value
...
Tabs.Settings:AddToggle({
    Name = "Tự động chống Admin vào server",
    Description = "",
    Default = true,
    Callback = function(Value)
...
Name = "Tự động làm nhiệm vụ Biển 2", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.TravelDres = Value
...
Name = "Tự động làm nhiệm vụ Biển 3", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.AutoZou = Value
...
Tabs.Quests:AddToggle({
Name = "Tự động farm nguyên liệu Skull Guitar", 
Description = "", 
Default = false,
Callback = function(Value)
...
Q = Tabs.Quests:AddToggle({
Name = "Tự động lấy CDK [Nhiệm vụ cuối]", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.CDK = Value
...
Q = Tabs.Quests:AddToggle({
Name = "Tween đến người bán kiếm Huyền Thoại", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.Tp_LgS = Value
...
Q = Tabs.Quests:AddToggle({
Name = "Tự động lấy Dark Blade V3", 
Description = "", 
Default = false,
Callback = function(Value)
...
Q = Tabs.Quests:AddToggle({
Name = "Tự động lấy kiếm Cavendish", 
Description = "", 
Default = false,
Callback = function(Value)
...
Q = Tabs.Quests:AddToggle({
Name = "Tự động dịch chuyển đến Barista Cousin", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.Tp_MasterA = Value
...
Q = Tabs.Quests:AddToggle({
Name = "Nhận nhiệm vụ Cầu Vồng nhanh hơn", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.GetQFast = Value
...
Q = Tabs.Quests:AddToggle({
Name = "Tự động luyện tập với hình nộm", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.DummyMan = Value
...
Name = "Tự động lấy Electric Claw", 
Description = "", 
Default = false,
Callback = function(Value)
...
Tabs.Race:AddToggle({
    Name = "Tự động tween đến đảo Mirage",
    Description = "",
    Default = false,
    Callback = function(Value)
...
Tabs.Race:AddToggle({
Name = "Tự động tween đến điểm cao nhất", 
Description = "", 
Default = false,
Callback = function(Value)
...
Tabs.Race:AddToggle({
Name = "Thay đổi độ trong suốt để có thể nhìn thấy", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.can = Value
...
Tabs.Race:AddToggle({
Name = "Tự động tween đến người bán trái nâng cao", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.Addealer = Value
...
Tabs.Race:AddToggle({
Name = "Tự động nhặt rương Mirage", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.FarmChestM = Value
...
Tabs.Race:AddToggle({
    Name = "Nhìn mặt trăng + tự động V3", 
    Description = "",
    Default = false,
    Callback = function(Value)
        LookMV3 = Value
...
Tabs.Race:AddButton({
Name = "Dịch chuyển đến đồng hồ cổ", 
Description = "",
Callback = function()
        local plr = game:GetService("Players").LocalPlayer
        local hrp = plr.Character and plr.Character:FindFirstChild("HumanoidRootPart")
...
Name = "Tự động dịch chuyển đến cửa Race", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.TPDoor = Value
...
Name = "Tự động hoàn thành thử thách Race", 
Description = "", 
Default = false,
Callback = function(Value)
...
Name = "Tự động giết người chơi sau thử thách", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.Defeating = Value
...
Name = "Tự động làm nhiệm vụ Dojo", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.Dojoo = Value
...
Name = "Tự động làm Dragon Hunter", 
Description = "", 
Default = false,
Callback = function(Value)
...
Name = "Tween để nâng cấp thử thách Draco", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.UPGDrago = Value
...
Toggle = Tabs.Prehistoric:AddToggle({
Name = "Tự động thử thách Relic Draco [Beta]", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.Relic123 = Value
...
Name = "Tween đến thử thách Draco", 
Description = "", 
Default = false,
Callback = function(Value)
...
Tabs.Prehistoric:AddToggle({
    Name = "Tự động bắt đầu sự kiện Tiền Sử",
    Default = false,
    Callback = function(Value)
...
Tabs.Prehistoric:AddToggle({
    Name = "Tự động sửa sự kiện Tiền Sử",
    Description = "",
    Default = false,
    Callback = function(Value)
...
Toggle = Tabs.Prehistoric:AddToggle({
Name = "Tự động reset khi hoàn thành núi lửa", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.ResetPH = Value
...
Tabs.SeaEvent:AddToggle({
Name = "Tự động đánh thành viên thủy thủ đoàn cá", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.MobCrew = Value
...
Tabs.SeaEvent:AddToggle({
Name = "Tự động đánh thành viên thủy thủ đoàn ma", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.HCM = Value
...
Tabs.SeaEvent:AddToggle({
Name = "Tự động dịch chuyển đến Shrine đã kích hoạt", 
Description = "", 
Default = false,
Callback = function(Value)
...
Tabs.SeaEvent:AddButton({
Name = "Nói chuyện với tượng Kitsune", 
Description = "",
Callback = function()
  replicated.Modules.Net:FindFirstChild("RE/TouchKitsuneStatue"):FireServer()
end})
...
Tabs.SeaEvent:AddToggle({
Name = "Tự động lái đến đảo Hydra", 
Description = "", 
Default = false,
Callback = function(Value)
...
Name = "Tự động chọn Chip Dungeon", 
Description = "", 
Default = false,
Callback = function(Value)
...
Tabs.Raids:AddToggle({
    Name = "Lấy trái trong kho dưới 1M",
    Default = false,
    Callback = function(Value)
...
Tabs.Raids:AddButton({
Name = "Mua Chip Dungeon [Trái Ác Quỷ]", 
Description = "",
Callback = function()
...
AutoChipFruit = Tabs.Raids:AddToggle({
    Name = "Tự động mua Chip [Trái Ác Quỷ]",
    Description = "",
    Default = false,
    Callback = function(Value)
...
Raiding = Tabs.Raids:AddToggle({
    Name = "Tự động Raid + đảo tiếp theo",
    Description = "",
    Default = false,
    Callback = function(Value)
        _G.Raiding = Value
...
Tabs.Raids:AddToggle({
    Name = "Tự động dịch chuyển đến Lab",
    Default = false,
    Callback = function(Value)
        _G.TpLab = Value
        StopTween(_G.TpLab)
...
Tabs.Raids:AddToggle({
    Name = "Tự động mua Microchip Law", 
    Description = "",
    Default = false,
    Callback = function(Value)
...
Tabs.Combat:AddToggle({
    Name = "Dịch chuyển đến người chơi đã chọn",
    Description = "",
    Default = false,
    Callback = function(Value)
        _G.TpPly = Value
...
Tabs.Combat:AddToggle({
    Name = "Theo dõi người chơi đã chọn",
    Description = "",
    Default = false,
    Callback = function(Value)
        SpectatePlys = Value
...
Tabs.Combat:AddToggle({
    Name = "Camera Aimbot đến người chơi gần nhất",
    Description = "",
    Default = false,
    Callback = function(Value)
        _G.AimCam = Value
...
Tabs.Combat:AddToggle({
    Name = "Tự động lấy nhiệm vụ người chơi",
    Description = "",
    Default = false,
    Callback = function(Value)
...
Tabs.Combat:AddToggle({
    Name = "Tự động giết người chơi trong nhiệm vụ", 
    Default = false,
    Callback = function(Value)
...
Name = "Di chuyển đến East Blue (Thế giới 1)", 
Description = "",
Callback = function()
  replicated.Remotes.CommF_:InvokeServer("TravelMain")
end})
Tabs.Travel:AddButton({
Name = "Di chuyển đến Dressrosa (Thế giới 2)", 
Description = "",
Callback = function()
  replicated.Remotes.CommF_:InvokeServer("TravelDressrosa")
end})
Tabs.Travel:AddButton({
Name = "Di chuyển đến Zou (Thế giới 3)", 
Description = "",
Callback = function()
  replicated.Remotes.CommF_:InvokeServer("TravelZou")
end})
...
Tabs.Misc:AddButton({
Name = "Đổi sang server ít người nhất", 
Description = "",
Callback = function()
  local Http = game:GetService("HttpService")
  local TPS = game:GetService("TeleportService")
...
Tabs.Misc:AddButton({
Name = "Đổi sang server ping thấp nhất", 
Description = "",
Callback = function()
local HTTPService = game:GetService("HttpService")
local TeleportService = game:GetService("TeleportService")
...
Name = "Tắt giao diện bảng xếp hạng", 
Description = "", 
Default = false,
Callback = function(Value)
  ReLeader = Value
...
Tabs.Misc:AddButton({
Name = "Chọn đội Hải Tặc", 
Description = "",
Callback = function()
  Pirates()
end})  
Tabs.Misc:AddButton({
Name = "Chọn đội Hải Quân", 
Description = "",
Callback = function()
  Marines()
end})
UnPortal = Tabs.Misc:AddToggle({
Name = "Mở khóa tất cả cổng", 
Description = "", 
Default = false,
Callback = function(Value)
